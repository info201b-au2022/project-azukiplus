...
second_drug_usage
overall_drug_status
first_lottery_frequency
second_lottery_frequency
overall_lottery_frequency
# # load packages
# library(foreign)
# library("dplyr")
# library("tidyverse")
